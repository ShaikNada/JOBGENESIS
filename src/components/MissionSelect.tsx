...
export const MissionSelect = ({ onStart }: Props) => {
  ...
  return (
    // FIX: Changed to h-screen with overflow-y-scroll to FORCE scrolling UI
    <div className="h-screen w-full bg-dark-950 text-white font-sans selection:bg-neon-red selection:text-white flex flex-col relative overflow-y-scroll overflow-x-hidden">
