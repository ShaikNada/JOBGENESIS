...
const AI_API_URL = `${API_URL}/api/ai`;
...
export async function evaluateSubmission(payload: any) {
    const res = await fetch(`${AI_API_URL}/evaluate`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
    });
...
export async function assistCandidate(payload: any) {
    const res = await fetch(`${AI_API_URL}/assist`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
    });
...
export async function analyzeComplexity(code: string, language: string) {
    const res = await fetch(`${AI_API_URL}/analyze-complexity`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
export async function getHint(code: string, language: string, problemDescription: string) {
    const res = await fetch(`${AI_API_URL}/hint`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
export async function fetchTechnicalExam(payload: any) {
    const res = await fetch(`${AI_API_URL}/technical-exam`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
    });
